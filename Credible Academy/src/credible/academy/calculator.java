...
public class calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        display.setFont(new java.awt.Font("Lucida Bright", 1, 18)); // NOI18N
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        else if(opt.equals("cbrt"))
        {
            equal= Math.cbrt(firstnum);
        }
        else
        {
       ...
       if(opt.equals("-"))
        {
          ...
          display.setText(String.valueOf(equal));
        firstnum=0;
        secondnum=0;
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        // TODO add your handling code here:
        hospitalmanagement jFrame2 = new hospitalmanagement();
        jFrame2.setVisible(true);
        jFrame2.setSize(980,620);
